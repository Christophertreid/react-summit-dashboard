  ...
  return (
    <s.Sidebar>
      ...
      <s.PageSection>
        ...
        <s.PageLink to="/dashboard/analytics">
        ...
        <s.PageLink to="/dashboard/report">
      ...
      <s.PageSection>
        ...
        <s.PageLink to="/dashboard/customer">
        ...
        <s.PageLink to="/dashboard/shipment">
      ...
      <s.PageSection>
        <s.PageLink to="/dashboard/category">
        ...
        <ProductOptions  />
        <s.PageLink to="/dashboard/promotion">
      ...
      <s.PageSection>
        <s.PageLink to="/dashboard/inventory">
        ...
        <s.PageLink to="/dashboard/vendor">
        ...
        <s.PageLink to="/dashboard/recall">
